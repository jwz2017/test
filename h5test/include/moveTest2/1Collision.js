import { DrawnIsoBox, DrawnIsoTile, Point3D } from "../../classes/3d/3DClass.js";
...
export class Collision extends Game {
    ...
    runGame() {
        ...
        rect.x+=box.vx;
        rect.y+=box.vz;
        if (!box.hitActors(this.moveChildren,rect)) {
            box.xpos += box.vx;
            box.ypos += box.vy;
            box.zpos += box.vz;
        }
        this.sortDepth(this.moveLayer);
    }
