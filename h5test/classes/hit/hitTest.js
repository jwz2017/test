...
//旋转矩形碰撞
export class OBB {
  static detectorOBBvsOBB = function (OBB1, OBB2) {
    let nv = new Vector(OBB1.actor.x - OBB2.actor.x, OBB1.actor.y - OBB2.actor.y);
  ...
  constructor(actor) {
    this.actor = actor;
    let rotation = actor.rotation * Math.PI / 180;
    let width = actor.rect.width;
    let height = actor.rect.height;
